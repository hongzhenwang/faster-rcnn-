function gather_rpn_fast_rcnn_models_with_ori(conf_proposal, conf_fast_rcnn, model, dataset)
    cachedir = fullfile(pwd, 'output', 'faster_rcnn_final', [model.final_model.cache_name,'_with_ori']);
    ...
    [fast_rcnn_test_net_def_file, fast_rcnn_output_model_file] = find_last_output_model_file(model.stage1_fast_rcnn, model.stage_ori);
