function model_stage = do_ori_train(conf, dataset, model_stage, do_val)
    if ~do_val
        dataset.imdb_test = struct();
        dataset.roidb_test = struct();
    end

    model_stage.output_model_file = ori_train_with_bboxes(conf, dataset.imdb_train, dataset.roidb_train, ...
                                    'do_val',           do_val, ...
