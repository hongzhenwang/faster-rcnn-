function model = ZF_for_Faster_RCNN_plane_con3_ori(model)
...
model.stage_ori.solver_def_file          = fullfile(pwd, 'models', 'ori_prototxts', 'ZF_con3', 'solver_ori_20k30k_con3.prototxt');
model.stage_ori.test_net_def_file        = fullfile(pwd, 'models', 'ori_prototxts', 'ZF_con3', 'test_ori_con3.prototxt');
