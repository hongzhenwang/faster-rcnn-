...
% inputs
    ...
    ip.addParamValue('val_iters',           60,                @isscalar);
...
%     caffe_solver.net.copy_from('/home/whz/DNN/faster_rcnn-master/output/rpn_cachedir/faster_rcnn_VOC2007_ZF_stage1_rpn/voc_2007_trainval/iter_30000');
%         caffe_solver.restore('/home/whz/DNN/faster_rcnn-master/output/rpn_cachedir/faster_rcnn_VOC2007_ZF_stage1_rpn/voc_2007_trainval/iter_30000');
    % init log
...
function model_path = snapshot(conf, caffe_solver, bbox_means, bbox_stds, cache_dir, file_name)
    ...
    bbox_pred_layer_name = 'proposal_bbox_pred_plane';
